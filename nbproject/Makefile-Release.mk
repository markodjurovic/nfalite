...
${OBJECTDIR}/src/cpp/core/nfa/state/BaseState.o: src/cpp/core/nfa/state/BaseState.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/core/nfa/state/BaseState.o src/cpp/core/nfa/state/BaseState.cpp
...
${OBJECTDIR}/src/cpp/core/nfa/state/manager/StateManager.o: src/cpp/core/nfa/state/manager/StateManager.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/core/nfa/state/manager/StateManager.o src/cpp/core/nfa/state/manager/StateManager.cpp
...
${OBJECTDIR}/src/cpp/test/TestRTTIClass.o: src/cpp/test/TestRTTIClass.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/test/TestRTTIClass.o src/cpp/test/TestRTTIClass.cpp

${OBJECTDIR}/src/cpp/test/TestState.o: src/cpp/test/TestState.cpp
	${MKDIR} -p ${OBJECTDIR}/src/cpp/test
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/test/TestState.o src/cpp/test/TestState.cpp
