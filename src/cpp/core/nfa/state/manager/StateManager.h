        ...
        namespace state{
            ...
            namespace manager{
                ...
                private:
                    ...
                    std::unordered_map<std::shared_ptr<core::nfa::state::BaseState>, std::unordered_set<std::shared_ptr<core::nfa::state::BaseState>>> findStatesConflicts(std::unordered_set<std::shared_ptr<core::nfa::state::BaseState>> states);
                protected:
                public:
